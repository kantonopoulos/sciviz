...
def venn(ax, data, group, var, palette='npg_nrc', alpha=0.9, label_color='black', label_size=11, label_weight='bold', innertext=None, innertext_color='black', innertext_size=10, format_labels=True):
