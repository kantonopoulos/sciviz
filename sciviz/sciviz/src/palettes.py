...
def sciviz_palette(palette):
    """Return a list of colors for the specified palette.

    Args:
        palette (str): The name of the palette to retrieve.

    Returns:
        list: The list of colors in the specified palette.
    """
    if palette in PALETTES:
        palette = list(PALETTES[palette].values())
    
    return palette


def get_palette(palette, data=None, color=None):
    """Return a list of colors for the specified palette.

    Args:
        palette (str or list): The name of the palette to retrieve or a list of colors.
        data (DataFrame): The data to use for the color attribute.
    ...
    # Keep only as many colors as unique values in the data
    if type(palette) == list:
        palette = palette[:len(data[color].unique())]
