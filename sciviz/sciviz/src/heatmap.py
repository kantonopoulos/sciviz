...
from sciviz import sciviz
from palettes import get_palette
def heatmap(ax, data, cluster_rows=True, cluster_cols=True, palette='Spectral', dendrogram=0.1, row_annot=None, row_pal=None, col_annot=None, col_pal=None, show_cbar=True, cbar_ticks=None, cbar_lim=None):
    ...
    if cluster_rows or cluster_cols:
        ...
        ax = sns.heatmap(data, cmap=palette, ax=ax)
